            ...
            <div id="scroll1" class="mui-scroll-wrapper">
                <div class="mui-scroll">
                    <ul class="mui-table-view" id="list">
                        <li v-for="item in meetingList" class="dataList mui-table-view-cell">
                            <div v-if="type==0">
    ...
    methods: {  
         myMeeting(res){
            ...
            request({
                ...
                params:{
                    roomName: "",
                    status: this.$store.state.dd, //0=未结束的，=1一结束的
                    pageSize: 20, //默认是20条
                    page: page
                }
            }).then(res=>{
               ...
               // this.orderList=res.data.data;
                ...
                if(this.pageIndex<=this.pageTotal){ 
                    ...
                    this.meetingList=this.meetingList.concat(addedArray)
                    this.pageIndex++;
                }else{
